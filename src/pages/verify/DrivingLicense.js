...
const DrivingLicense = (props) => {
    ...
    let LicenceFrontImageCover =user && user.drivingFront && (user.drivingFront !=="driving_front.jpg" ) ? PHOTO_URL+user.drivingFront : nidFronImageCover

    let LicenceBackImageCover =user && user.drivingBack && (user.drivingBack !=="driving_back.jpg" )  ? PHOTO_URL+user.drivingBack : nidFronImageCover
    ...
    function handleFormSubmit(e) {
        ...
        if (projectImages[IMAGE_FIELD]) {
            try {
                ...
                fetch(`${BASE_URL}/users/${user.id}/upload-driving-photo`, requestOptions)
    ...
    return (
        ...
        <form onSubmitCapture={handleFormSubmit}  className="py-8  ">
            ...
            <p className=" text-base font-medium text-left py-2 text-gray-400 text-base">Upload Driving Licence </p>
                ...
                <div
                    ...
                    <label htmlFor="image1" className="cursor-pointer">
                        ...
                        <div className="relative flex flex-col items-center justify-center cursor-pointer">
                            ...
                            <img src={projectImages[IMAGE_FIELD] ? projectImages[IMAGE_FIELD] : LicenceFrontImageCover}
                                 className="h-20 w-20 text-center mx-4 " alt="tick sign"/>

                            <div
                                className="flex flex-row group-hover:text-blue-400 group-hover:text-2xl text-sm transform translate group-hover:scale-120 ">
                                <img src={uploaderIcon} alt="uploader icon" className="h-5 w-5"/>
                ...
                <div
                    ...
                    <label htmlFor="image2" className="cursor-pointer">
                        ...
                        <div className="flex flex-col items-center justify-center cursor-pointer">
                            ...
                            <img src={projectImages2[IMAGE_FIELD] ? projectImages2[IMAGE_FIELD] : LicenceBackImageCover}
                                 className="h-20 w-20 text-center mx-4 " alt="tick sign"/>
            ...
            {(projectImages[IMAGE_FIELD] && projectImages2[IMAGE_FIELD]) && <button
