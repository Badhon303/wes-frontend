...
export default function Verify(props) {
    ...
    const [verificationType, setVerificationType] = useState(VERIFICATION_TYPE_NID);
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            ...
            FetchApi.sendPutRequest(`${BASE_URL}/users/${user.id}`, values, { credentials: true })
                .then((res) => {
        ...
        formFields = (
            <>
                <div className="col-span-6 sm:col-span-3">
                    <label htmlFor="nidFront" className="py-1 block text-sm font-medium text-gray-700 py-1">NID front</label>

                    <input
                        id="nidFront" type="file"
                    ...
                    />
                    {formik.touched.nidFront && formik.errors.nidFront && (<Warning message={formik.errors.nidFront}></Warning>)}
                </div>
                <div className="col-span-6 sm:col-span-3">
                    <label htmlFor="nidBack" className="py-1 block text-sm font-medium text-gray-700 py-1">NID back</label>

                    <input
                        id="nidBack" type="file"
                        // onChange={formik.handleChange}
                        // onBlur={formik.handleBlur} value={formik.values.nidBack}
                        placeholder="Upload NID back"
                        className="border-2 py-2 w-full text-sm text-black bg-white rounded-md px-4 focus:outline-none focus:bg-white focus:text-gray-900"
                    />
                    {formik.touched.nidBack && formik.errors.nidBack && (<Warning message={formik.errors.nidBack}></Warning>)}
                </div>
            </>
    )
    } else if (verificationType === VERIFICATION_TYPE_PASSPORT) {
        formFields = (
            <Passport onVerificationStatusUpdate={handleVerificationStatusChange} onCancel={handleCancelVerification}/>
        )
    } else if (verificationType === VERIFICATION_TYPE_DRIVING_LICENSE) {
        formFields = (
            <DrivingLicense onVerificationStatusUpdate={handleVerificationStatusChange}
        ...
        <Layout>
            <div className="bg-white rounded-t-xl  w-full   items-center justify-center md:mx-auto ">
                <div className="px-6 md:px-0 lg:px-0 xl:px-0 w-full items-center justify-center md:mx-auto  shadow ">
                    ...
                    <h1 className="text-center py-2 text-xl font-black"> Identity Verification </h1>
                    <div className="grid grid-cols-12  mx-auto p-6  mt-4 mb-2 bg-white ">
                        ...
                        <div className="col-span-8">
                            <form onSubmit={formik.handleSubmit}>
                                ...
                                <p className="px-2 text-xl font-bold text-left py-4 "> Basic Information </p>
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    <label htmlFor="nickName"
                                           className="py-1 block text-sm font-medium text-gray-700 py-1">Middle
                                        Name</label>

                                    <input
                                           id="nickName" onChange={formik.handleChange} onBlur={formik.handleBlur}
                                           value={formik.values.nickName} placeholder="Enter nick name"
                                           className="border-2 py-2 w-full text-sm text-black bg-white rounded-md px-4 focus:outline-none focus:bg-white focus:text-gray-900"
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    <label htmlFor="lastName" className="py-1 block text-sm font-medium text-gray-700">Last
                                        name</label>
                                    <input

                                        id="lastName" onChange={formik.handleChange} onBlur={formik.handleBlur}
                                        value={formik.values.lastName} placeholder="Enter last name"
                                        className="border-2 py-2 w-full text-sm text-black bg-white rounded-md px-4 focus:outline-none focus:bg-white focus:text-gray-900"
                                    />
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    <label htmlFor="dob"
                                           className="py-1 block text-sm font-medium text-gray-700 py-1">Date of
                                        birth</label>

                                    <input
                                           id="dob" type="date" onChange={formik.handleChange}
                                           onBlur={formik.handleBlur} value={formik.values.dob}
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    ...
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="country" className="block text-sm font-medium text-gray-700 py-1">Nationality</label>
                                        <select
                                ...
                                <p className="px-2 text-xl font-bold text-left  pt-8 pb-4"> Residential Address </p>
                                ...
                                <div className=" col-span-6 sm:col-span-3 ">
                                    <label htmlFor="postal_code"
                                           className="block text-sm font-medium text-gray-700 py-1">ZIP / Postal</label>
                                    <input
                                ...
                                <div className="col-span-6 sm:col-span-3 ">
                                    ...
                                    <input
                                           ...
                                           value={formik.values.state} placeholder="Enter state/city"
                                           className="border-2 py-2 w-full text-sm text-black bg-white rounded-md px-4 focus:outline-none focus:bg-white focus:text-gray-900"
                                ...
                                <p className="px-2 text-xl font-bold text-left  pt-8 pb-4"> Identity Verify</p>
                                ...
                                {/*<div className="col-span-6 sm:col-span-3">*/}
                                    ...
                                    <div className="col-span-6 sm:col-span-6">
                                        ...
                                        <div className="mt-2">
                                            <label className="inline-flex items-center">
                                                <input
                                                    ...
                                                    onChange={() => setVerificationType(VERIFICATION_TYPE_NID)}
                                                    type="radio" className="form-radio h-6 w-6" name="accountType"
                                                       value="nid"/>
                                                    <span className="ml-2">NID</span>
                                            </label>
                                            <label className="inline-flex items-center ml-6">
                                                <input checked={verificationType === VERIFICATION_TYPE_PASSPORT}
                                                    onChange={() => setVerificationType(VERIFICATION_TYPE_PASSPORT)}
                                                       type="radio" className="form-radio h-6 w-6 " name="accountType"
                                                       value="driving"/>
                                                    <span className="ml-2">Driving Licence</span>
                                            </label>
                                            <label className="inline-flex items-center ml-6">
                                                <input checked={verificationType === VERIFICATION_TYPE_DRIVING_LICENSE}
                                                    onChange={() => setVerificationType(VERIFICATION_TYPE_DRIVING_LICENSE)}
                                                       type="radio" className="form-radio h-6 w-6" name="accountType"
                                                       value="passport"/>
                                        ...
                                        <div className="card text-left">
                                            <div className="col-span-6 sm:col-span-3">
                                                <label htmlFor="ront" className="py-1 block text-sm font-medium text-gray-700 py-1">Front image</label>

                                                <input
                                                    id="front" type="file"
                                                    onChange={event => handleVerificationFileUploadEvent(event, 'front')}
                                                    placeholder="Upload front"
                                                    className="border-2 py-2 w-full text-sm text-black bg-white rounded-md px-4 focus:outline-none focus:bg-white focus:text-gray-900"
                                                />
                                                {formik.touched.front && formik.errors.front && (<Warning message={formik.errors.front}></Warning>)}
                                            </div>
                                            <div className="col-span-6 sm:col-span-3">
                                                <label htmlFor="back" className="py-1 block text-sm font-medium text-gray-700 py-1">Back image</label>

                                                <input
                                                    id="back" type="file"
                                                    onChange={event => handleVerificationFileUploadEvent(event, 'back')}
                                                    placeholder="Upload back"
                                                    className="border-2 py-2 w-full text-sm text-black bg-white rounded-md px-4 focus:outline-none focus:bg-white focus:text-gray-900"
                                                />
                                                {formik.touched.back && formik.errors.back && (<Warning message={formik.errors.back}></Warning>)}
                                            </div>
                                        </div>
                                    </div>
