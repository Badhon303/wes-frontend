...
;
    ...
    const nidFronImageCoverUrl = user && user.nidFront && (user.nidFront !== "nid_front.jpg") ? PHOTO_URL+user.nidFront : nidFronImageCover;
    const nidBackImageCoverUrl =user && user.nidBack   && (user.nidBack !== "nid_back.jpg")  ? PHOTO_URL+user.nidBack: nidFronImageCover;
    ...
    return (
        ...
        <form onSubmitCapture={handleFormSubmit}>
            <div className="py-8  ">
                ...
                <p className=" text-base font-medium text-left py-2 text-gray-400 text-base">Upload ID/NID Card </p>
                ...
                <div className=" flex flex-col  ">
                    ...
                    <div
                        ...
                        <label htmlFor="image1" className="cursor-pointer">
                            ...
                            <div className="relative flex flex-col items-center justify-center cursor-pointer">
                                ...
                                <img src={projectImages['mycard-photo'] ? projectImages['mycard-photo'] : nidFronImageCoverUrl}
                    ...
                    <div
                        ...
                        <label htmlFor="image2" className="cursor-pointer">
                            ...
                            <div className="flex flex-col items-center justify-center cursor-pointer">
                                ...
                                <img src={projectImages2['mycard-photo'] ? projectImages2['mycard-photo'] : nidBackImageCoverUrl}
                                     className="h-20 w-20 text-center mx-4 " alt="tick sign"/>
                    ...
                    <p className="text-sm text-red-400 text-left">Upload .jpg, .jpeg or .png file and not exceeding
                        10M</p>

                </div>
                {(projectImages['mycard-photo']) && <button
