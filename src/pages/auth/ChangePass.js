...
const validate = (values) => {
  ...
  //  else if (!/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d@$!%*#?&]{4,8}$/i.test(values.oldPassword)) {
  //  errors.oldPassword = 'Must be between 4 to 8 characters and at least 1 character and 1 numeric number';
  //  }
  if (!password) {
  ...
  if (!passwordConfirm) {
    ...
    errors.passwordConfirm = "Does not matched with old password";
  }
  return errors;
};
  ...
  return (
    <Layout>
      <form onSubmit={formik.handleSubmit}>
        <div className=" w-full md:w-90 xl:w-90 2xl:w-full md:border-t-1 items-center justify-center md:mx-auto ">
            ...
            <div className="mx-auto p-4 mt-12 mb-2 bg-white ">
              ...
              <div className="m-3 pt-4">
                ...
                {formik.touched.oldPassword && formik.errors.oldPassword && (
                  <div className="my-2 bg-red-100 py-2 text-sm text-red-700">
