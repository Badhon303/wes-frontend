                ...
                <div
                    ...
                    <div
                        ...
                        <div className="mx-auto p-4  mt-12 mb-2 bg-white shadow rounded-2xl">
                            <h2 className="pt-8 pb-4  text-black  text-xl lg:text-2xl  text-center ">Sign up</h2>

                            {nickName && <div className="w-100 m-3 pb-4">
                                ...
                                <div className="bg-gray-50  text-gray-700 focus-within:text-gray-400">
                                    ...
                                    >Referred by<span className="pl-1">{nickName[1]}</span></p>
                            ...
                            <div className="w-100 m-3">
                                ...
                                {formik.touched.nickName && formik.errors.nickName && (
                                    <div
                                        className="mt-2 px-2 text-sm bg-red-100 py-2 text-red-700">{formik.errors.nickName}</div>)}
                            ...
                            <div className="w-100 m-3 pt-4">
                                ...
                                {formik.touched.email && formik.errors.email && (
                                    <div
                                        className="mt-2 px-2 text-sm bg-red-100 py-2 text-red-700">{formik.errors.email}</div>)}
                            </div>
                            {loading &&
                            ...
                            <div className="w-100 m-3 pt-4">
                                ...
                                {formik.touched.password && formik.errors.password && (
                                    <div
                                        className="mt-2 px-2 text-sm bg-red-100 py-2 text-red-700">{formik.errors.password}</div>)}
                            </div>
                            ...
                            <div className="m-3 pt-6 flex justify-between">
                                ...
                                <Link to="/forgot-password"> <span
                                    className=" text-lg text-site-theme hover:underline hover:text-red-400">Forgot password ?</span></Link>
                            </div>
