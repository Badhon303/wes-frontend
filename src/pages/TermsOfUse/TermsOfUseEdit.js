...
import { customStylesModal } from "../../utils/styleFunctions.js"
...
export default function TermsOfuseEdit({
  ...
  const [teromsOfuse, setTeromsOfuse] = useState("")
  ...
  function updateUseOfTerms(data) {
    return sendPostRequest(`/terms-conditions/sections`, data, {
      credential: true,
    })
  }
      ...
      .then((res) => {
        ...
        if (res.ok) {
          Swal.fire({
            title: "Success",
            icon: "success",
            text: "Successfully Terms of use template updated",
          })
              ...
              <div className='bg-white shadow px-4 md:px-10 pt-4 md:pt-7 pb-5 overflow-auto'>
                <div className='my-4'>
                  ...
                  <div className='w-full bg-gray-50 text-black font-medium p-4 rounded break-words'>
                    {teromsOfuse && Object.keys(teromsOfuse)[0]}
                  </div>
                </div>
                ...
                <div className='my-4'>
                  ...
                  <div className='w-full bg-gray-50 text-black font-medium p-4 rounded break-all'>
                    {teromsOfuse && teromsOfuse.preamble}
                  </div>
                </div>
                {!loading && (
                  <button
                    onClick={handleModalCallback}
                    className='mt-12   flex items-center flex-cols mx-auto rounded text-center px-12 py-3 bg-red-400 text-white shadow hover:shadow-xl text-base font-bold'
                  >
                    {" "}
                    Close
                  </button>
              ...
              <div className='bg-white shadow px-4 md:px-10 pt-4 md:pt-7 pb-5 overflow-auto'>
                ...
                <div className='mb-40 mt-12  flex items-center mx-32'>
                  {!loading && (
                    <button
                      onClick={handleModalCallback}
                      className='flex items-center flex-cols mx-auto rounded text-center px-12 py-3 bg-red-400 text-white shadow hover:shadow-xl text-base font-bold'
                    >
                      {" "}
                      Close
                    </button>
