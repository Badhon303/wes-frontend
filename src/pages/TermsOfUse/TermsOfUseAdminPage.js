...
import TermsOfuseEdit from "./TermsOfUseEdit"
...
export default function TermsOfUseAdminPage() {
  ...
  const [termsOfUseId, setTermsOfUseId] = useState(null)
  ...
  //       ) {
  //         Swal.fire("Cancelled", "Your email template file is safe :)", "success")
  //       }
  //     })
  //   }
  ...
  return (
    <main className='m-6'>
      ...
      {teromsOfuse && (
        // teromsOfuse.map((obj, index) => (
        <div
          //   key={index}
          className='my-3  p-4 flex justify-between break-words items-center text-base   border  rounded text-gray-800'
        >
          <p>
            {/* {index + 1} Subject:{obj.title}{" "} */}
          ...
          <div className='flex items-center'>
            {/* <div
              ...
              onClick={() => handleView(Object.keys(teromsOfuse)[0])}
            >
              <svg
