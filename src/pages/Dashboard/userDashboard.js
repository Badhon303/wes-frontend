...
export default function UserDashboard(props) {
    ...
    const photoUrl = user && userInfo && userInfo.photo !== "no-photo.jpg" ? PHOTO_URL + userInfo.photo : AvatarLogo;
    ...
    function updateBchType(cb) {
        ...
        if((!btcInfo || !btcInfo.bitcoin || btcInfo.bitcoin==="" || !btcInfo  ) && cb.value==="Bitcoin"){
            Swal.fire({
    ...
    else if (user && ( (user.approvalStatus === "pending" || user.approvalStatus ==="unapplied")  &&
        (!user.firstName && ((user.nidBack === "nid_back.jpg" &&
            user.nidFront === "nid_front.jpg") ||
            user.passportBiodata === "passport_biodata.jpg" ||
            (user.drivingBack === "driving_back.jpg" && user.drivingFront === "driving_front.jpg")))))
                    ...
                    <div className="grid grid-cols-12 gap-4 ">
                        <div className="col-span-12 md:col-span-6 order-1 md:order-1 ">
                            ...
                            <div className="flex md:pt-6  md:pb-2 py-2 items-center justify-content-center word-break ">
                                <div
                                    className="rounded-full px-4 py-3 border-1 shadow text-base text-bold"> {userInfo && userInfo.nickName.slice(0, 2)}</div>
                        ...
                        <div className="px-4 xl:px-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2">
                                ...
                                <div>
                                    <p className="mb-1.5 text-md text-gray-500 font-medium">Select Crypto Currency</p>

                                    <div className="w-64 ">
                                        <DropDownMenuWithIcon
                                            defaultValue={btcInfo && btcInfo.ether ?   "Ether" : "Select Coin"}
                                            ...
                                            placeholder={btcInfo && btcInfo.ether ?   "Ether" : "Select Coin"}
                                ...
                                <div>
                                    <p className="py-2 text-md text-gray-500 font-medium">Introducer Name:
                                        <span className="pl-2"> {user && introducer &&
                                        introducer.email ?
                                            introducer.email : ''}</span>

                                        <span className="pl-0"> {
                                            user && introducer && introducer.nickName ?
                                                (introducer.email ? '(' : '')+introducer.nickName+(introducer.email ? ')' : '')  : ''}</span>
                                    </p>
                                </div>
                            </div>
                        ...
                        {btcInfo &&  address ? <div>
                                <p className="mt-4 text-md text-gray-500 font-medium">Address</p>
                                <div
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-6 lg:gap-4 gap-2 ">
                            ...
                            <div className="col-span-2  bg-site-bg rounded shadow mt-4">
                                <div className="p-2 md:p-4">
                                    ...
                                    <p className="text-title  text-base xl:text-xl text-center py-2 md:py-4 word-break overflow-hidden"> {referralPoint ? referralPoint.totalPoint : ""}</p>
                                </div>
