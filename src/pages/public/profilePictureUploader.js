...
export default function ProfilePictureUploader(props) {
    ...
    const setImageAction = async (event) => {
        ...
        const data = await fetch(`${BASE_URL}/users/${user.id}/upload-profile-photo`, {
            method: "put",
        ...
        if (uploadedImage && uploadedImage.success===true) {
            ...
            Swal.fire("Profile Picture Uploaded Successfullly", "", "Success").then((result)=>{
                props.cb && props.cb();
            });
                        ...
                        <div className="relative w-auto my-8 mx-auto max-w-3xl">
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className="md:px-24 p-8 flex-auto">
                                    ...
                                    <p className="py-4 text-bold text-gray-600 text-center"> Update Profile Picture </p>
                                    <div
                                        className={"group my-2 cursor-pointer shadow border-1 text-gray-400 text-center py-4  bg-white text-black" }>
                                        ...
                                        <label htmlFor="image1"  className="cursor-pointer">
                                            ...
                                            <div className="relative flex flex-col items-center justify-center cursor-pointer">
                                                ...
                                                <img src={picture && picture.picturePreview  ?  picture.picturePreview  : AvatarImage} className="h-64 w-64  text-center  " alt="Avatar"/>
                                    ...
                                    <p className="text-sm text-red-400 text-left">Upload .jpg, .jpeg or .png file and not exceeding 2M</p>
                                </div>
                                {/*footer*/}
