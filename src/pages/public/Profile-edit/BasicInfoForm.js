...
export default function BasicInfoForm(props) {
  ...
  const photoUrl =
    user && user.photo !== "no-photo.jpg" ? PHOTO_URL + user.photo : AvatarLogo
  ...
  return (
    <div>
      <div className='flex flex-col items-center md:items-center pt-12  '>
        <img
          src={user && photoUrl ? photoUrl : AvatarLogo}
          ...
          <div className='grid grid-cols-6 gap-x-8  gap-y-4'>
            ...
            <div className='col-span-6 sm:col-span-3'>
              <p className='text-sm font-normal text-left  '>
                <span className='text-red-600 pt-2 mr-1'>*</span>Country Name{" "}
              </p>
            ...
            <div className=' col-span-6 sm:col-span-3 '>
              <label
                ...
                className='block text-sm  text-gray-700 py-1'
              >
                <span className='text-red-600 pt-2 mr-1'>*</span>National Id
              </label>
              <input
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
