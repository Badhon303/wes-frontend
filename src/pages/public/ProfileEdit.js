...
export default function ProfileEdit(props) {
  ...
  const formik = useFormik({
    initialValues: {
      nationality:
        user && user.nationality && user.nationality ? user.nationality : "",
      firstName: user && user.firstName && user.firstName ? user.firstName : "",
      lastName: user && user.middleName ? user.middleName : "",
      spouseName:
        user && user.spouseName && user.spouseName ? user.spouseName : "",
                              ...
                              <div className='col-span-6 sm:col-span-3'>
                                ...
                                {formik.touched.spouseName &&
                                  formik.errors.spouseName && (
                                    <Warning
                                      message={formik.errors.spouseName}
                                    ></Warning>
                                  )}
                              </div>
