...
const App = () => (
    <Switch>
        ...
        <PublicRoute restricted={false} component={PasswordForgot} path="/forgot-password" exact/>
        <PublicRoute restricted={false} component={PasswordReset} path="/reset-password" exact/>
        ...
        <PrivateRoute component={AdminExchangeHistory} path="/gp-exchange-history" />
        ...
        <PrivateRoute component={ReferralPurchaseHistory} path="/referral-purchase-history" />
        <PrivateRoute component={ReferralRewardHistory} path="/referral-reward-history" />
