...
// const user = UserInfo();
// console.log("ei holo user: ", user);
// const token = getLoginStatus();
// console.log("ei holo token: ", token);
...
//   const [updateCMSProfile, { data, error, loading }] = useMutation(
//     PROFILE_UPDATE_API,
//     {
//       onError(error) {
...
//       (values.OldPassword === undefined || values.OldPassword === "") &&
//       name
//     ) {
//       if (name !== user.name) {
//         updateCMSProfile({
