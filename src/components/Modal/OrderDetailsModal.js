          ...
          <div className="border shadow  border-gray-200 ">
            <div className="py-4 px-6  group ">
              ...
              <div className="grid grid-cols-12 gap-4 ">
                ...
                <p className="col-span-7 text-gray-600 md:text-base text-sm break-all">
                  {" "}
                  {getReadableTime(orders.ordered_at)}
                </p>
              </div>
            </div>
          </div>
                  ...
                  <p className=" col-span-8 px-2 cursor-pointer text-gray-700 group-hover:underline group-hover:text-site-theme break-all">
                    {/* <a target="_blank"
                                           href={process.env.REACT_APP_ENV === "dev" ?
                                               ...
                                               (orders.payment_currency === "BTC" ? "https://www.blockchain.com/btc/tx/" + result.tx_id : "https://etherscan.io/tx/" + result.tx_id)}>
                                                   {result.tx_id} </a> */}
                    <a
                      target="_blank"
                      href={"https://etherscan.io/tx/" + result.tx_id}
                    >
                      {result.tx_id}{" "}
                    </a>
                  </p>
