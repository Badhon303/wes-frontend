    ...
    <>
      {showModal ? (
        <>
          ...
          >
            <div className='relative md:w-auto my-8 p-2  mx-auto md:max-w-3xl'>
              {/*content*/}
              <div className=' border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
                {/*header*/}
                <div className='flex items-start md:justify-between border-solid border-gray-300 rounded-t'>
                  <div
                    className='md:px-6 px-10 py-3 md:ml-auto cursor-pointer '
                    onClick={handleModalCallback}
                  >
                    <svg
                ...
                <div className=' '>
                  <div className='flex  '>
                    <div className=' md:my-8 md:items-center md:justify-items-center'>
                      <p className='text-center text-xl font-black px-4 pt-8 pb-6 text-site-theme'>
                        {" "}
                        Your Shareable Link is{" "}
                      </p>

                      <p className='mx-auto md:text-center md:text-xl text-black font-black md:p-4  word-break text-sm'>
                        <span className='pl-12 pr-10 md:px-1'>
                          {" "}
                          {props.linkCode}{" "}
                        </span>
                      </p>
