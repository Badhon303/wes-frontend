                                ...
                                <div className=" ">
                                    ...
                                    <div className="flex  ">
                                        ...
                                        <div className=" md:my-8 md:items-center md:justify-items-center">
                                            ...
                                            <p className="mx-auto md:text-center md:text-xl text-black font-black md:p-4  word-break text-sm"><span className="pl-12 pr-10 md:px-1"> {props.linkCode}  </span></p>
