                          ...
                          <div className="px-4 py-5 bg-white sm:p-6">
                            <div className="grid grid-cols-6 gap-6">
                              ...
                              <div className="col-span-12">
                                <label htmlFor="nickName" className="block text-sm font-medium text-gray-700 py-1 ">Nick Name</label>
                                <input id="nickName"
                                  type="text"
                              ...
                              <div className="col-span-12">
                                <label htmlFor="email" className="block text-sm font-medium text-gray-700 py-1">Email</label>
                                <input id="email"
                                  type="email"
                                ...
                                {formik.touched.email && formik.errors.email && (<Warning message={formik.errors.email}></Warning>)}
                              </div>
                              <div className="col-span-12">
                                <label htmlFor="password" className="block text-sm font-medium text-gray-700 py-1">Password</label>
                                <input id="password"
                                  type="password"
                                  autoComplete="new-password"
                                  className="border-2 py-2 w-full text-sm text-black bg-white rounded-md px-4 focus:outline-none focus:bg-white focus:text-gray-900"
                                ...
                                {formik.touched.password && formik.errors.password && (<Warning message={formik.errors.password}></Warning>)}
                              </div>
